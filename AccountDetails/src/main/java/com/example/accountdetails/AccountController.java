...
public class AccountController {
    @PostMapping("/GetAgreementDetails")
    public ResponseEntity<AccountResponse> getAgreementDetails(@RequestBody AccountRequest request) {
        String soapRequest = String.format(
                "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
                        ...
                        "</get:GetAgreementDetailsRequest>\n" +
                        "</soapenv:Body>\n" +
                        "</soapenv:Envelope>", request.getAccountNumber());
